...
public class Constants {
    ...
    public static final String OPEN_WEATHERMAP_URL="http://api.openweathermap.org/data/2.5/forecast/daily?lat=%s&lon=%s&units=metric&cnt=5&appid=4933d328d31b7f96ccdc6322fe0ca17a";
